...
export default function Hero({ lang, setLang }: { lang: "de" | "en" | "it", setLang: (l: "de" | "en" | "it") => void }) {
  ...
  const t = {
    de: {
      os: "DevOps Engineer | EFZ",
      uptime: "EFZ Abgeschlossen ✓",
      scroll: "Scrollen für Systemarchitektur"
    },
    en: {
      os: "DevOps Engineer | EFZ",
      uptime: "EFZ Completed ✓",
      scroll: "Scroll for System Architecture"
    },
    it: {
      os: "DevOps Engineer | EFZ",
      uptime: "EFZ Completato ✓",
            ...
            <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.5 }} className="flex-1 w-full">
              <div className="mb-6">
                ...
                <div className="flex gap-2 flex-wrap mt-1 mb-2">
                  <span className="text-[10px] font-mono border border-emerald-800 text-emerald-500 px-2 py-0.5 rounded">DevOps Engineering</span>
                  <span className="text-[10px] font-mono border border-neutral-700 text-neutral-500 px-2 py-0.5 rounded">EFZ ✓</span>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-3 mb-8 text-neutral-300">
                ...
                <div className="flex gap-2"><span className="text-emerald-400 font-bold w-16">Kernel:</span> DevOps Engineering</div>
              ...
              <div className="space-y-4 border-t border-neutral-800/50 pt-6">
                <div className="grid grid-cols-[30px_1fr] items-start gap-3">
                  ...
                  <div><span className="text-blue-400 font-bold inline-block w-44 whitespace-nowrap">Infrastructure:</span><span className="text-neutral-300">Linux (Ubuntu/Debian), VMware vSphere, Windows Server</span></div>
                </div>
                <div className="grid grid-cols-[30px_1fr] items-start gap-3">
                  <Shield className="text-purple-400 shrink-0 mt-0.5" size={18} />
                  <div><span className="text-purple-400 font-bold inline-block w-44 whitespace-nowrap">Net & Security:</span><span className="text-neutral-300">Fortinet & Sophos Firewalls, Cisco, MS Intune</span></div>
                </div>
                <div className="grid grid-cols-[30px_1fr] items-start gap-3">
                  <Cloud className="text-cyan-400 shrink-0 mt-0.5" size={18} />
                  <div><span className="text-cyan-400 font-bold inline-block w-44 whitespace-nowrap">Cloud & DevOps:</span><span className="text-neutral-300">Docker, CI/CD, Public Cloud, IaC <span className="text-neutral-600 text-xs">(learning)</span></span></div>
                </div>
                <div className="grid grid-cols-[30px_1fr] items-start gap-3">
                  <Code className="text-yellow-400 shrink-0 mt-0.5" size={18} />
                  <div><span className="text-yellow-400 font-bold inline-block w-44 whitespace-nowrap">Scripting & Dev:</span><span className="text-neutral-300">PowerShell, Bash, Python, Next.js</span></div>
                </div>
              </div>
            </motion.div>
          </div>
